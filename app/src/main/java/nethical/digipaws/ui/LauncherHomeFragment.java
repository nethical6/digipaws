...
public class LauncherHomeFragment extends Fragment {
  ...
  public void onViewCreated(View arg0, Bundle arg1) {
    ...
    mmtimeTextView.setTypeface(
        Typeface.createFromAsset(requireContext().getAssets(), "regulartime.ttf"), Typeface.BOLD);
            ...
            new GestureDetector.SimpleOnGestureListener() {
              ...
              public boolean onFling(
                ...
                if (isSurvivalEnabled) {
                  showToast(
                      "Your device will be unlocked after " + survivalModeEndTime + " hours.");
                  return true;
                }
                ...
                if (Math.abs(diffY) > SWIPE_THRESHOLD) {
                  if (diffY < 0) {
                    ...
                    requireActivity()
                        ...
                        .replace(R.id.fragment_container, launcherAppsFragment)
                        .addToBackStack(null)
                        .commit();
                    return true;
                  }
