...
public class ListApps {
    ...
    public static String[] getNonIgnoredPackageNames(Context context) {
        ...
        String[] array1 = {"nethical.digipaws", "com.android.settings", "com.google.android.dialer","com.google.android.deskclock","android","com.google.android.gm","com.google.android.calendar","com.android.phone","com.google.android.cellbroadcastreceiver","com.android.systemui"};
	...
	private static List<AppModel> parseAppListFromJson(String json) {
		Gson gson = new Gson();
		Type type = new TypeToken<List<AppModel>>() {
		}.getType();
