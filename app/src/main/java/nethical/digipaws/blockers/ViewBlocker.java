...
public class ViewBlocker {
	...
	public static void performAction(AccessibilityService service, String packageName) {
		...
		if (packageMap != null) {
			...
			for (Map.Entry<String, BlockableView> entry : packageMap.entrySet()) {
				...
				AccessibilityNodeInfo viewNode = findElementById(rootNode, packageName + ":id/" + viewId);
				if (viewNode != null) {
					//view found
	...
	public static Map<String, BlockableView> getPackageMap(SharedPreferences preferences, String packageName) {
