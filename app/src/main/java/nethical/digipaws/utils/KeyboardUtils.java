...
public class KeyboardUtils {
	...
	public static void attachKeyboardHidingListener(final Context context, RecyclerView recyclerView) {
		...
		recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
			...
			public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
				...
				// Check if the user initiated a scroll gesture (ACTION_DOWN followed by ACTION_MOVE)
