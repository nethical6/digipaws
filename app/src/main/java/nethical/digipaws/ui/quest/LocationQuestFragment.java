...
public class LocationQuestFragment extends Fragment {
	...
	public void onViewCreated(View arg0, Bundle arg1) {
		...
		new Thread(() -> {
			...
			liveLocationTracker.setLiveLocationListener(new LocationHelper.LocationListener() {
				@Override
				public void onLocationChanged(Location location) {
					if (location != null) {
						...
						if (isQuestRunning) {
							...
							if (distance > 100) {
								Toast.makeText(requireContext(), "Quest Completed " + String.valueOf(distance),
		...
		locationHelperCircle.setLiveLocationListener(new LocationHelper.LocationListener() {
			@Override
			public void onLocationChanged(Location location) {
				if (location != null) {
